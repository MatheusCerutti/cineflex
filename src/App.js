  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/sucesso" element={<Sucesso filmeescolhido={filmeescolhido} horarioescolhido={horarioescolhido} dataescolhida={dataescolhida} assentoescolhido={assentoescolhido} comprador={comprador} cpfcomprador={cpfcomprador}/>}></Route>
      </Routes>
